...
class MyLIstAdapter(val listaUser : ArrayList<MyListModel>) : RecyclerView.Adapter<MyLIstAdapter.ComingSoonViewHolder>() {

    inner class ComingSoonViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
        fun bind(result: MyListModel) {
            val img = "https://image.tmdb.org/t/p/w185//${result.foto}"
